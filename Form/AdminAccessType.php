...
class AdminAccessType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('name', TextType::class, ['label' => 'Nom', 'disabled' => $options['data']->getIslocked() ? true : false])->add('roles', ChoiceType::class, ['choices' => $roles, 'label' => 'Choix des rôles', 'required' => false, 'multiple' => true, 'attr' => ['class' => 'js-select2'],]);
