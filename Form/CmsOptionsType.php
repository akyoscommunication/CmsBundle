...
//				]
//			])
            ->add('hasArchiveEntities', ChoiceType::class, ['label' => 'Activer la page archive sur les entités :', 'choices' => $options['entities'], 'choice_label' => function ($choice, $key, $value) {
                return $value;
            }, 'multiple' => true, 'expanded' => true])->add('hasSingleEntities', ChoiceType::class, ['label' => 'Activer les pages single sur les entités :', 'choices' => $options['entities'], 'choice_label' => function ($choice, $key, $value) {
                return $value;
            }, 'multiple' => true, 'expanded' => true])->add('hasSeoEntities', ChoiceType::class, ['label' => 'Activer le SEO sur les entités :', 'choices' => $options['entities'], 'choice_label' => function ($choice, $key, $value) {
                return $value;
