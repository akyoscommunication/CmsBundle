...
/**
 * @ORM\Entity(repositoryClass="Akyos\CmsBundle\Repository\MenuRepository")
 */
class Menu
{
	...
	/**
	 * @ORM\OneToMany(targetEntity="Akyos\CmsBundle\Entity\MenuItem", mappedBy="menu", orphanRemoval=true, cascade={"persist"})
	 * @OrderBy({"position" = "ASC"})
	 */
	private $menuItems;
	
	/**
	 * @ORM\OneToOne(targetEntity="Akyos\CmsBundle\Entity\MenuArea", mappedBy="Menu", cascade={"persist"})
	 */
	private $menuArea;
