...
#[Route(path: '/admin/site_option', name: 'option_')]
...
class OptionController extends AbstractController
{
    ...
    public function index(Request $request, OptionRepository $optionRepository, PageRepository $pageRepository, OptionCategoryRepository $categoryRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('@AkyosCms/option/index.html.twig', ['options' => $categoryRepository->findAll(), 'params' => $params, 'new_option_form' => $newOptionForm->createView(), 'title' => 'Réglages', 'entity' => 'Option', 'route' => 'option', 'fields' => ['Title' => 'Title', 'ID' => 'Id', 'Valeur' => 'Value'],]);
    }
     ...
     * @return Response
     */
    #[Route(path: '/remove/{id}', name: 'delete')]
